...
export const enumTasksIconIconName = pgEnum('enum_tasks_icon_icon_name', [
  'inst',
  'tg',
  'tiktok',
  'vk',
...
export const wallets = pgTable(
  'wallets',
  {
    ...
    createdAt: timestamp('created_at', { precision: 3, withTimezone: true, mode: 'string' }).defaultNow().notNull(),
    lastConnect: timestamp('last_connect', { precision: 3, withTimezone: true, mode: 'string' })
      .default('2025-01-05 18:58:17.814+00')
      .notNull(),
    updatedAt: timestamp('updated_at', { precision: 3, withTimezone: true, mode: 'string' }).defaultNow().notNull(),
  },
  (table) => [
...
export const users = pgTable(
  'users',
  {
    ...
    createdAt: timestamp('created_at', { precision: 3, withTimezone: true, mode: 'string' })
      .default('2025-01-05 18:58:17.814+00')
      .notNull(),
    lastVisit: timestamp('last_visit', { precision: 3, withTimezone: true, mode: 'string' }).default(
      '2025-01-05 18:58:17.814+00',
    ),
    ...
    claimFriends: timestamp('claim_friends', { precision: 3, withTimezone: true, mode: 'string' })
      .default('2025-01-06 18:58:17.814+00')
      .notNull(),
...
export const payloadPreferences = pgTable(
  ...
  (table) => [
    index('payload_preferences_created_at_3_idx').using(
      'btree',
      table.createdAt.asc().nullsLast().op('timestamptz_ops'),
    ),
    index('payload_preferences_key_3_idx').using('btree', table.key.asc().nullsLast().op('text_ops')),
    index('payload_preferences_updated_at_3_idx').using(
      'btree',
...
export const payloadMigrations = pgTable(
  ...
  (table) => [
    index('payload_migrations_created_at_3_idx').using(
      'btree',
      table.createdAt.asc().nullsLast().op('timestamptz_ops'),
    ),
    index('payload_migrations_updated_at_3_idx').using(
      'btree',
      table.updatedAt.asc().nullsLast().op('timestamptz_ops'),
    ),
  ],
...
export const payloadLockedDocuments = pgTable(
  ...
  (table) => [
    index('payload_locked_documents_created_at_3_idx').using(
      'btree',
      table.createdAt.asc().nullsLast().op('timestamptz_ops'),
    ),
    index('payload_locked_documents_global_slug_3_idx').using(
      'btree',
      table.globalSlug.asc().nullsLast().op('text_ops'),
    ),
    index('payload_locked_documents_updated_at_3_idx').using(
      'btree',
      table.updatedAt.asc().nullsLast().op('timestamptz_ops'),
    ),
  ],
...
export const payloadLockedDocumentsRels = pgTable(
  ...
  (table) => [
    index('payload_locked_documents_rels_admins_id_3_idx').using(
      'btree',
      table.adminsId.asc().nullsLast().op('int4_ops'),
    ),
    index('payload_locked_documents_rels_invites_id_3_idx').using(
      'btree',
      table.invitesId.asc().nullsLast().op('int4_ops'),
    ),
    index('payload_locked_documents_rels_media_id_3_idx').using(
      'btree',
      table.mediaId.asc().nullsLast().op('int4_ops'),
    ),
    index('payload_locked_documents_rels_messages_id_3_idx').using(
      'btree',
      table.messagesId.asc().nullsLast().op('int4_ops'),
    ),
    ...
    index('payload_locked_documents_rels_tasks_id_3_idx').using(
      'btree',
      table.tasksId.asc().nullsLast().op('int4_ops'),
    ),
    index('payload_locked_documents_rels_user_tasks_id_3_idx').using(
      'btree',
      table.userTasksId.asc().nullsLast().op('int4_ops'),
    ),
    index('payload_locked_documents_rels_users_id_3_idx').using(
      'btree',
      table.usersId.asc().nullsLast().op('int4_ops'),
    ),
    index('payload_locked_documents_rels_wallets_id_3_idx').using(
      'btree',
      table.walletsId.asc().nullsLast().op('int4_ops'),
    ),
    foreignKey({
      columns: [table.parentId],
