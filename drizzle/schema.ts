...
export const wallets = pgTable("wallets", {
	...
	createdAt: timestamp("created_at", { precision: 3, withTimezone: true, mode: 'string' }).defaultNow().notNull(),
	lastConnect: timestamp("last_connect", { precision: 3, withTimezone: true, mode: 'string' }).default('2025-01-02 12:52:55.428+00').notNull(),
	updatedAt: timestamp("updated_at", { precision: 3, withTimezone: true, mode: 'string' }).defaultNow().notNull(),
}, (table) => [
...
export const users = pgTable("users", {
	...
	createdAt: timestamp("created_at", { precision: 3, withTimezone: true, mode: 'string' }).defaultNow().notNull(),
	lastVisit: timestamp("last_visit", { precision: 3, withTimezone: true, mode: 'string' }).default('2025-01-02 12:52:55.428+00'),
	...
	claimFriends: timestamp("claim_friends", { precision: 3, withTimezone: true, mode: 'string' }).default('2025-01-03 12:52:55.428+00').notNull(),
	...
	index("users_created_at_3_idx").using("btree", table.createdAt.asc().nullsLast().op("timestamptz_ops")),
	...
	index("users_updated_at_3_idx").using("btree", table.updatedAt.asc().nullsLast().op("timestamptz_ops")),
	foreignKey({
